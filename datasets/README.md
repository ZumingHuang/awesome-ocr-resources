...
| --- | --- | --- | --- | --- |
| [SeeWye/NFA_OCR_reinforcement_learning_format_TEST2](https://huggingface.co/datasets/SeeWye/NFA_OCR_reinforcement_learning_format_TEST2) | 2026-08-22 | text-recognition | candidate | — |
