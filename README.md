...
| --- | ---: | --- |
| [Papers](papers/README.md) | 243 | Research on OCR, document parsing, layout analysis, and document understanding |
| [Models](models/README.md) | 102 | Public model cards, weights, APIs, and official model releases |
| [Datasets](datasets/README.md) | 49 | Training datasets and evaluation benchmarks |
| [Codes](codes/README.md) | 32 | Notable OCR and Document AI codebases |
| [Skills](skills/README.md) | 103 | Installable agent skills for OCR and document workflows |
